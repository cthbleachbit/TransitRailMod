...
import tk.cth451.transitrailmod.blocks.PlatformSign;

public class ModBlocks {
	public static Block closed_platform_top;
	public static Block closed_platform_door_block;
	public static Block closed_platform_panel;
	public static Block logo_block;
	public static Block platform_sign;
	
	public static void init() {
		closed_platform_top = new ClosedPlatformTop(Material.cloth).setUnlocalizedName("closed_platform_top");
		logo_block = new LogoBlock(Material.iron).setUnlocalizedName("logo_block");
